...
<div class="container">
	<form:form method="post" modelAttribute="expense"><!-- As we are passing Expense object directly we need to add this modelattribute with 
		...
		<fieldset class="form-group">
			<form:label path="credit">Credit:</form:label> <form:input type="number" path="credit" class="form-control"/><!-- path is replacement of name="" and should match Expense model vars -->
		</fieldset>
		<fieldset class="form-group">
			<form:label path="debit">Debit:</form:label> <form:input type="number" path="debit" class="form-control"/>
		</fieldset>
		<fieldset class="form-group">
